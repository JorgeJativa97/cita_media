...
class imprimirCorrecion3{

public $cedula; 
public function traerImpresionCorrecion3(){
...
$respuesta2= ControladorCorrecion::ctrMostrarCorrecionEx("persona.cedula", $valor);
...
ob_end_clean();
$pdf->Output('correcion3.pdf', 'I');

}

}

$correcion3 = new imprimirCorrecion3();
$correcion3 -> cedula = $_GET["cedula"];
$correcion3 -> traerImpresionCorrecion3();
