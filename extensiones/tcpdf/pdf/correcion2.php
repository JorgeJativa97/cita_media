...
class imprimirCorrecion2{

public $cedula; 
public function traerImpresionCorrecion2(){
...
$respuesta2= ControladorCorrecion::ctrMostrarCorrecionE("persona.cedula", $valor);
...
ob_end_clean();
$pdf->Output('correcion2.pdf', 'I');

}

}

$correcion2 = new imprimirCorrecion2();
$correcion2 -> cedula = $_GET["cedula"];
$correcion2 -> traerImpresionCorrecion2();
